...
map.getView().fit([12564690.415939, 441996.437677, 15016468.975231, 2445913.858409], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">NSHP - UPDATING OF THEMATIC MAPS</h2>';
        return titleElement;
    })(),
